...
export IMAGE_URL=${IMAGE_URL-quay.io/tsscui/backend-tests-python-xfxobtmy:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-test-org/backend-tests-python-xfxobtmy-gitops
